...
package sa.models.ODSLiabilities

import common.models.ApiValue
...
object ODSLiabilities {
  ...
  private case object CGOtherGainsAfterLoss extends ODSLiabilities("atsCGOtherGainsAfterLoss")
  ...
  private case object NRGTGainsAfterLoss extends ODSLiabilities("atsNRGTGainsAfterLoss")
  ...
  case object TaxOnTransitionProfits extends ODSLiabilities("ctnTaxOnTransitionPrft")
  ...
  private case object EmployerNI extends ODSLiabilities("employerNic")
  ...
  private case object PensionLumpSumTaxRate extends ODSLiabilities("ctnPensionLumpSumTaxRate")
