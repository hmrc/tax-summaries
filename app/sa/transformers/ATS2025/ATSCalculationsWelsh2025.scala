...
class ATSCalculationsWelsh2025(val summaryData: TaxSummaryLiability, val taxRates: TaxRateService)
  ...
  override def scottishIncomeTax: Amount = Amount.empty("scottishIncomeTaxWelsh2025")
}
