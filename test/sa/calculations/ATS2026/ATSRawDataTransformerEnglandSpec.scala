...
class ATSRawDataTransformerEnglandSpec extends BaseSpec with ATSRawDataTransformerBehaviours {
  s"atsDataDTO for England 2026" must {
    ...
    "use the correct capital gains rates" in new ATSRawDataTransformerTestFixtureEngland {
    ...
    behave like atsRawDataTransformerWithTotalTaxLiabilityChecks(
      expTotalTaxLiabilityValue = BigDecimal(15699.65),
