...
class ATSRawDataTransformerScotlandSpec extends BaseSpec with ATSRawDataTransformerBehaviours {
  s"atsDataDTO for Scotland 2026" must {
    "use the correct tax rates" in new ATSRawDataTransformerTestFixtureScotland {
      transformedData.income_tax.flatMap(_.rates).map(_.toSet) mustBe Some(
        Set(
          ...
          ScottishIncomeAdvancedRate     -> ApiRate("45%"),
          ScottishIncomeAdditionalRate   -> ApiRate("48%"),
          ...
          ScottishIncomeHigherRate       -> ApiRate("42%"),
    ...
    behave like atsRawDataTransformerWithTotalTaxLiabilityChecks(
      expTotalTaxLiabilityValue = BigDecimal(18216.58),
...
protected trait ATSRawDataTransformerTestFixtureScotland extends ATSRawDataTransformerTestFixtureBase {
  ...
  override def expectedResultIncomeTax: Map[LiabilityKey, Amount] = super.expectedResultIncomeTax ++ Map(
    StartingRateForSavingsAmount  -> calcExp("savingsRateAmountScottish2026:null"),
    SavingsLowerIncome            -> calcExp("ctnSavingsChgbleLowerRate"),
    SavingsLowerRateTax           -> calcExp("ctnSavingsTaxLowerRate"),
    ScottishIncomeTax             -> calcExp("scottishIncomeTaxScottish2026:null"),
    ...
    StartingRateForSavings        -> calcExp("savingsRateScottish2026:null"),
    AdditionalRateIncomeTax       -> calcExp("additionalRateIncomeTaxScottish2026:null"),
    ...
    HigherRateIncomeTax           -> calcExp("higherRateIncomeTaxScottish2026:null"),
    ScottishBasicRateTax          -> calcExp("ctnIncomeTaxBasicRate", "ctnTaxOnRedundancyBr", "ctnPensionLsumTaxDueAmt:null"),
    BasicRateIncomeTaxAmount      -> calcExp("basicRateIncomeTaxAmountScottish2026:null"),
    ...
    AdditionalRateIncomeTaxAmount -> calcExp("additionalRateIncomeTaxAmountScottish2026:null"),
    ...
    BasicRateIncomeTax            -> calcExp("basicRateIncomeTaxScottish2026:null"),
    SavingsAdditionalRateTax      -> calcExp("ctnSavingsTaxAddHighRate", "ctnTaxOnCegAhr"),
    HigherRateIncomeTaxAmount     -> calcExp("higherRateIncomeTaxAmountScottish2026:null"),
    TotalIncomeTax                -> expTotalIncomeTax,
    ...
    ScottishAdvancedRateTax       -> calcExp(
      "taxOnPaySar",
      "taxOnRedundancySar",
      "ctnPensionLsumTaxDueAmt:null"
    ),
  ...
  override protected def expSavingsIncomeTaxDivs: Amount = calcExp(
    "savingsRateAmountScottish2026:null",
    "basicRateIncomeTaxAmountScottish2026:null",
    "higherRateIncomeTaxAmountScottish2026:null",
    "additionalRateIncomeTaxAmountScottish2026:null",
