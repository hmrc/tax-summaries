...
class ATSCalculationsTest extends BaseSpec with ScalaCheckPropertyChecks with DoubleUtils {
  ...
  class CalcFixtures(val taxYear: Int, val origin: Nationality, applicationConfig: ApplicationConfig)(
    ...
    lazy val calculationAsOpt: Option[ATSCalculations] = ATSCalculations.make(taxSummaryLiability, taxRateService)
    lazy val calculationAsValue: ATSCalculations       = ATSCalculations.make(taxSummaryLiability, taxRateService).get
  }
  ...
  "make" must {
    "return the latest calculations class for nationality when year > latest" when {
      "country is UK" in {
        val calculation = new Fixture(9999, UK())().calculationAsValue
        calculation mustBe a[ATSCalculationsUK2023]
      }
      "country is Scotland" in {
        val calculation = new Fixture(9999, Scottish())().calculationAsValue
        calculation mustBe a[ATSCalculationsScottish2023]
      }
      "country is Wales" in {
        val calculation = new Fixture(9999, Welsh())().calculationAsValue
    ...
    "return None" when {
      "tax year is < 2020 and type is scottish" in {
        val calculation = new Fixture(2019, Scottish())().calculationAsOpt
        calculation mustBe None
      }

      "tax year is < 2020 and type is welsh" in {
        val calculation = new Fixture(2019, Welsh())().calculationAsOpt
        calculation mustBe None
      }

      "tax year is < 2020 and type is UK" in {
        val calculation = new Fixture(2019, UK())().calculationAsOpt
        calculation mustBe None
      }
    }
    ...
    "return ATSCalculationsUK2020" when {
      "tax year is 2020 and type is UK" in {
        val calculation = new Fixture(2021, UK())().calculationAsValue
  ...
  "2020UKATSCalculations" must {
    ...
    val calculation = fixture.calculationAsOpt

    "return an empty amount for scottishIncomeTax" in {

      calculation.get.scottishIncomeTax mustBe Amount.empty("scottishIncomeTaxUK2020")
    }

    "return empty for savingsRate" in {

      calculation.get.savingsRate mustBe Amount.empty("savingsRateUK2020")
    }

    "return empty for savingsRateAmount" in {

      calculation.get.savingsRateAmount mustBe Amount.empty("savingsRateAmountUK2020")
    }

    "return empty for welshIncomeTax" in {
      calculation.get.welshIncomeTax mustBe Amount.empty("welshIncomeTax")
    }
  }
  ...
  "2020ScottishATSCalculations" must {
    ...
    val calculation     = scottishFixture().calculationAsOpt

    "return an empty amount for scottishIncomeTax" in {
      calculation.get.scottishIncomeTax mustBe Amount.empty("scottishIncomeTaxScottish1019")
    }

    "return an empty amount for basicRateIncomeTaxAmount" in {
      calculation.get.basicRateIncomeTaxAmount mustBe Amount.empty("basicRateIncomeTaxAmountScottish2020")
    }

    "return an empty amount for higherRateIncomeTaxAmount" in {
      calculation.get.higherRateIncomeTaxAmount mustBe Amount.empty("higherRateIncomeTaxAmountScottish2020")
    }

    "return an empty amount for additionalRateIncomeTaxAmount" in {
      calculation.get.additionalRateIncomeTaxAmount mustBe Amount.empty("additionalRateIncomeTaxAmountScottish2020")
    }

    "return an empty amount for basicRateIncomeTax" in {
      calculation.get.basicRateIncomeTax mustBe Amount.empty("basicRateIncomeTaxScottish2020")
    }

    "return an empty amount for higherRateIncomeTax" in {
      calculation.get.higherRateIncomeTax mustBe Amount.empty("higherRateIncomeTaxScottish2020")
    }

    "return an empty amount for additionalRateIncomeTax" in {
      calculation.get.additionalRateIncomeTax mustBe Amount.empty("additionalRateIncomeTaxScottish2020")
    }

    "return empty for savingsRate" in {

      calculation.get.savingsRate mustBe Amount.empty("savingsRateScottish2020")
    }

    "return empty for savingsRateAmount" in {

      calculation.get.savingsRateAmount mustBe Amount.empty("savingsRateAmountScottish2020")
    }
    ...
    "scottishStarterRateTaxAmount includes pension tax when pension rate matches starter rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishStarterRateTax mustBe Amount.gbp(
          income + pension,
    ...
    "scottishBasicRateTaxAmount includes pension tax when pension rate matches basic rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishBasicRateTax.roundAmount() mustBe Amount
    ...
    "scottishIntermediateRateTaxAmount includes pension tax when pension rate matches intermediate rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishIntermediateRateTax.roundAmount() mustBe Amount
    ...
    "scottishHigherRateTaxAmount includes pension tax when pension rate matches higher rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishHigherRateTax.roundAmount() mustBe Amount
    ...
    "scottishAdditionalRateTaxAmount includes pension tax when pension rate matches additional rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishAdditionalRateTax.roundAmount() mustBe Amount
    ...
    "scottishStarterRateIncome include pension lump sum amount when matches starter rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishStarterRateIncome.roundAmount() mustBe Amount
    ...
    "scottishStarterRateIncome include pension lump sum amount when matches basic rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishBasicRateIncome.roundAmount() mustBe Amount
    ...
    "scottishStarterRateIncome include pension lump sum amount when matches intermediate rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishIntermediateRateIncome
    ...
    "scottishStarterRateIncome include pension lump sum amount when matches higher rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishHigherRateIncome.roundAmount() mustBe Amount
    ...
    "scottishStarterRateIncome include pension lump sum amount when matches additional rate" in {
      ...
      forAll { (incomeVal: Double, pensionVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishAdditionalRateIncome.roundAmount() mustBe Amount
    ...
    "savingsBasicRateTax returns tax on savings" in {
      ...
      forAll { taxVal: Double =>
        ...
        sut.calculationAsOpt.get.savingsBasicRateTax
    ...
    "savingsHigherRateTax returns tax on savings" in {
      ...
      forAll { taxVal: Double =>
        ...
        sut.calculationAsOpt.get.savingsHigherRateTax
    ...
    "savingsAdditionalRateTax returns tax on savings" in {
      ...
      forAll { taxVal: Double =>
        ...
        sut.calculationAsOpt.get.savingsAdditionalRateTax
    ...
    "savingsBasicRateIncome returns income on savings" in {
      ...
      forAll { taxVal: Double =>
        ...
        sut.calculationAsOpt.get.savingsBasicRateIncome
    ...
    "savingsHigherRateIncome returns income on savings" in {
      ...
      forAll { taxVal: Double =>
        ...
        sut.calculationAsOpt.get.savingsHigherRateIncome
    ...
    "savingsAdditionalRateIncome returns income on savings" in {
      ...
      forAll { taxVal: Double =>
        ...
        sut.calculationAsOpt.get.savingsAdditionalRateIncome
    ...
    "scottishTotalTax includes any 2 random scottish taxes" in {
      ...
      forAll { (firstVal: Double, secondVal: Double) =>
        ...
        sut.calculationAsOpt.get.scottishTotalTax
          .roundAmount()
    ...
    "totalIncomeTaxAmount includes any 2 random scottish taxes or savings taxes" in {
      ...
      forAll { (firstVal: Double, secondVal: Double) =>
        ...
        sut.calculationAsOpt.get.totalIncomeTaxAmount
          .roundAmount()
  ...
  "WelshATSCalculations" must {
    "calculate the welshIncomeTax" in {
      ...
      forAll { (basicRateVal: Double, higherRateVal: Double, additionalRateVal: Double) =>
        ...
        sut.calculationAsOpt.get.welshIncomeTax
          .roundAmount() mustBe Amount
          .gbp(
          ...
          .roundAmount()
      //sut.calculation.get.savingsRate mustBe Amount.gbp(0.0, "") //TODO: to be fixed
      //sut.calculation.get.savingsRateAmount mustBe Amount.gbp(0.0, SavingsTaxStartingRate.apiValue) //TODO: to be fixed
      //sut.calculation.get.scottishIncomeTax mustBe Amount.gbp(0.0, "to be fixed") //TODO: to be fixed
      }
    }
  }
}
